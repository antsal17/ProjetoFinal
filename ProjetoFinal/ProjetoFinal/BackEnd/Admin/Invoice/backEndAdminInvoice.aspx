<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="backEndAdminInvoice.aspx.cs" Inherits="ProjetoFinal.BackEnd.Admin.invoice.backEndAdminInvoice" %>
                                            ...
                                            <table class="table table-hover thead-primary">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>10</td>
                                                        <td>$10</td>
                                                        <td><a href='#'><i class='fas fa-paper-plane text-success'></i></a><a href='a.html'><i class='far fa-trash-alt ms-text-danger'></i></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
