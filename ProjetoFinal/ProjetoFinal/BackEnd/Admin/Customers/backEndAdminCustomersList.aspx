<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="backEndAdminCustomersList.aspx.cs" Inherits="ProjetoFinal.BackEnd.Admin.customers.backEndAdminCustomersList" %>
                ...
                <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
                    ...
                    <li class="menu-item">
                        ...
                        <ul id="customer" class="collapse" aria-labelledby="customer" data-parent="#side-nav-accordion">
                            <li><a href="customersreview.html">Customers Review</a>
                            </li>
                            <li><a href="customerlist.html">Customers List</a>
                            </li>
                            <li><a href="addcustomer.html">Add Customer</a>
                            </li>
                        </ul>
                    </li>
                    <!-- Customers  end -->
                    <!-- Apps -->
                    <li class="menu-item">
                        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#apps" aria-expanded="false" aria-controls="apps"><span><i class="material-icons fs-16">mode_comment</i>Chats</span>
                        </a>
