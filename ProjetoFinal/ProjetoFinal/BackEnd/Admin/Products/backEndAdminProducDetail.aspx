<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="backEndAdminProducDetail.aspx.cs" Inherits="ProjetoFinal.BackEnd.Admin.Products.backEndAdminProducDetail" %>
                                    ...
                                    <div id="arrowSlider" class="ms-arrow-slider carousel slide" data-ride="carousel" data-interval="false">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="../assets/img/costic/banner-1.jpg" alt="First slide"/>
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h3 class="text-white">Main image</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
