...
namespace ProjetoFinal.Classes.FunctionClasses
{
    ...
    {
        public static void enviaEmailNovoUtilizador(string email, string id, string nome, int id_tipoUtilizador, string pass, bool inseridoPorUtilizador, bool ativo)
        {
            ...
            m.Subject = "Registo Loja Online";
            m.IsBodyHtml = true;
            if (inseridoPorUtilizador == true) //o utilizador foi inserido por ele mesmo, por isso não é necessário enviar pass word
            {
                if (id_tipoUtilizador == 4)//Sendo cliente normal, é ele que ativa a conta logo a mensagem vai nesse sentido
                {
                    m.Body = menssagemAtivacao(id, nome);
                }
                else//Sendo vendedor, quem ativa a conta é o admin logo a mensagem vai nesse sentido
                {
                    m.Body = menssagemAguardaAtivacao(id, nome);
                }
            }
            else// o utilizador foi inserido pelo admin logo está automaticamente ativo e a mensagem vai com a passe word caso 
            {
                m.Body = menssagemComPass(id, nome, pass);
            }
 ...
 "</html>";
        ...
        private static string menssagemAguardaAtivacao(string id, string nome)
        {
                                                            ...
                                                            "<td align='left' style='font-size:0px;padding:10px 25px;padding-top:48px;padding-right:40px;padding-bottom:24px;padding-left:40px;word-break:break-word'>" +
                                                                "<div style='font-family:Arial,sans-serif;font-size:13px;line-height:24px;text-align:left;color:#5e6977'><p style='line-height:36px;margin:10px 0;margin-top:10px'>" +
                                                                    ...
                                                                    "</p><p style='line-height:36px;margin:10px 0'> &nbsp;</p><p style='line-height:36px;margin:10px 0'>" +
                                                                        "<span style='color:#000000'><span style='font-size:30px'>" +
                                                                        "<b/>" +
                                                                            "<span style='font-family:Montserrat,Helvetica,Arial,sans-serif'>Muito obrigado por se registar no XProcurarPalavraX</span>" +
                                                                            "</b></span></span></p><p style='line-height:36px;margin:10px 0'><span style='color:#000000'>" +
                                                                            "<span style='font-size:30px'>" +
                                                                            "<b/><span style='font-family:Montserrat,Helvetica,Arial,sans-serif'>O Seu pedido Foi encominhado para a administracao.</span>" +
                                                                            "</b></span></span></p><p style='line-height:36px;margin:10px 0'>" +
                                                                            "<span style='color:#8f23b3'><span style='font-size:30px'>" +
                                                                            "<b/><span style='font-family:Montserrat,Helvetica,Arial,sans-serif'> Aguarde a ativacao da Sua Conta</span>" +
                                                                            "</b></span></span></p><p style='line-height:36px;margin:10px 0'><span style='font-family:Montserrat,Helvetica,Arial,sans-serif'>" +
                                                                            "<span style='font-size:12px'> Olá " + nome + " ,</span></span></p><p style='line-height:32px;margin:10px 0'>" +
                                                                            "<span style='font-family:Montserrat,Helvetica,Arial,sans-serif'>" +
                                                                            "<span style='font-size:12px'> Este é apenas o início de uma bela amizade.</span></span></p><p style='margin:10px 0'>" +
                                                                            "<span style='font-family:Montserrat,Helvetica,Arial,sans-serif'><span style='font-size:12px'> Vamos a isso? No Dott há um mundo de marcas para descobrir e uma experiência de compra sem igual.</span></span></p><p style='margin:10px 0;margin-bottom:10px'> &nbsp;</p>" +
                                                                  "</div>" +
                                                             "</td>" +
                                                        "</tr>" +
 ...
 "</html>";
        ...
        private static string menssagemComPass(string id, string nome, string password)
        {
                                                                ...
                                                                "<div style='font-family:Arial,sans-serif;font-size:13px;line-height:24px;text-align:left;color:#5e6977'><p style='line-height:36px;margin:10px 0;margin-top:10px'>" +
                                                                    ...
                                                                    "</p><p style='line-height:36px;margin:10px 0'> &nbsp;</p><p style='line-height:36px;margin:10px 0'>" +
                                                                        ...
                                                                        "<b/>" +
                                                                            ...
                                                                            "</b></span></span></p><p style='line-height:36px;margin:10px 0'><span style='color:#000000'>" +
                                                                            "<span style='font-size:30px'>" +
                                                                            "<b/><span style='font-family:Montserrat,Helvetica,Arial,sans-serif'>Foi adicionado aos registos da XProcuraPalavraX</span>" +
                                                                            "</b></span></span></p><p style='line-height:36px;margin:10px 0'>" +
                                                                            "<span style='color:#8f23b3'><span style='font-size:30px'>" +
                                                                            "<b/><span style='font-family:Montserrat,Helvetica,Arial,sans-serif'></span>" +
                                                                            "</b></span></span></p><p style='line-height:36px;margin:10px 0'><span style='font-family:Montserrat,Helvetica,Arial,sans-serif'>" +
                                                                            "<span style='font-size:12px'> Olá " + nome + " ,</span></span></p><p style='line-height:32px;margin:10px 0'>" +
                                                                            "<span style='font-family:Montserrat,Helvetica,Arial,sans-serif'>" +
                                                                            "<span style='font-size:12px'> Junto enviamos a sua Palavra Passe : "+ password + "</span></span></p><p style='margin:10px 0'>" +
                                                                            "<span style='font-family:Montserrat,Helvetica,Arial,sans-serif'><span style='font-size:12px'> Vamos a isso? No Dott há um mundo de marcas para descobrir e uma experiência de compra sem igual.</span></span></p><p style='margin:10px 0;margin-bottom:10px'> &nbsp;</p>" +
                                                                  "</div>" +
                                                             "</td>" +
                                                        "</tr>" +
